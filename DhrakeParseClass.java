...
public class DhrakeParseClass extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        this.log(this.getCurrentProgram().getLanguage().toString()); // x86/little/32/default
        this.log(this.getCurrentProgram().getLanguageID().getIdAsString()); // x86:LE:32:default
        this.log(this.getCurrentProgram().getCompiler()); // borland:pascal
        this.log(this.getCurrentProgram().getCompilerSpec().getCompilerSpecDescription().getCompilerSpecName()); // Delphi
        this.log(this.getCurrentProgram().getCompilerSpec().getCompilerSpecID().getIdAsString()); // borlanddelphi
        this.log(this.getCurrentProgram().getCompilerSpec().getDefaultCallingConvention().getName()); // __register
        this.log(this.getCurrentProgram().getLanguageCompilerSpecPair().toString()); // x86:LE:32:default:borlanddelphi
